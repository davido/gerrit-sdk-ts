...
/**
 * Check if a given object implements the CommentInfo interface.
 */
export function instanceOfCommentInfo(value: object): value is CommentInfo {
    return true;
}

export function CommentInfoFromJSON(json: any): CommentInfo {
    return CommentInfoFromJSONTyped(json, false);
}

export function CommentInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommentInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function CommentInfoToJSON(json: any): CommentInfo {
    return CommentInfoToJSONTyped(json, false);
}

export function CommentInfoToJSONTyped(value?: CommentInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
